...
public class HashFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TasteSweet=(ToggleButton)rootView.findViewById(R.id.TasteSweet);
        TasteSpicy=(ToggleButton)rootView.findViewById(R.id.TasteSpicy);
        TasteClean=(ToggleButton)rootView.findViewById(R.id.TasteClean);
        TasteNutty=(ToggleButton)rootView.findViewById(R.id.TasteNutty);
        TasteSalty=(ToggleButton)rootView.findViewById(R.id.TasteSalty);
        TasteFresh=(ToggleButton)rootView.findViewById(R.id.TasteFresh);

        IDTxt=(EditText)rootView.findViewById(R.id.IDTxt);
        LogBtn=(Button)rootView.findViewById(R.id.LogBtn);

        resultTxt=(TextView)rootView.findViewById(R.id.TestView);//test
    ...
    public void onClick(View v) {
        if(v.equals(BtnSave)){
            ...
            if(cnt!=3){
                ...
                task.execute(IDTxt.getText().toString(),ta1,ta2,ta3);
            }
        }
